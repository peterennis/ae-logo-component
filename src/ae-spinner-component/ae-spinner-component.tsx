        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100px" height="100px" viewBox="0 0 128 128" space="preserve">
            <g>
              ...
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#e7f2e9" fill-opacity="0.12" transform="rotate(90 64 64)" />
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#e7f2e9" fill-opacity="0.12" transform="rotate(135 64 64)" />
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#cce4cf" fill-opacity="0.25" transform="rotate(180 64 64)" />
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#add3b3" fill-opacity="0.41" transform="rotate(225 64 64)" />
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#8cc295" fill-opacity="0.57" transform="rotate(270 64 64)" />
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#65ad70" fill-opacity="0.76" transform="rotate(315 64 64)" />
            ...
            <g>
              <circle fill={this.color} fill-opacity="1" cx="63.66" cy="63.16" r="12" />
