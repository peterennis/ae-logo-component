        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100px" height="100px" viewBox="0 0 128 128" xml:space="preserve">
            <g>
              ...
              <path d="M59.6 0h8v40h-8V0z" fill="#281525" fill-opacity="0.2" transform="rotate(60 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#281525" fill-opacity="0.2" transform="rotate(90 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#281525" fill-opacity="0.2" transform="rotate(120 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#3d2038" fill-opacity="0.3" transform="rotate(150 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#512b4b" fill-opacity="0.4" transform="rotate(180 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#65365e" fill-opacity="0.5" transform="rotate(210 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#794070" fill-opacity="0.6" transform="rotate(240 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#8e4b83" fill-opacity="0.7" transform="rotate(270 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#a25696" fill-opacity="0.8" transform="rotate(300 64 64)"/>
              <path d="M59.6 0h8v40h-8V0z" fill="#b661a9" fill-opacity="0.9" transform="rotate(330 64 64)"/>
              <animateTransform attributeName="transform" type="rotate" values="330 64 64;300 64 64;270 64 64;240 64 64;210 64 64;180 64 64;150 64 64;120 64 64;90 64 64;60 64 64;30 64 64;0 64 64" calcMode="discrete" dur="1080ms" repeatCount="indefinite"></animateTransform>
            </g>
          </svg>
        )
      case 'hearts':
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 128 128" space="preserve">
            ...
            <g>
              ...
              <path fill={this.color} fill-opacity="1" d="M62.531,63.4l2.6,1.5L34.257,118.374l-2.6-1.5Z" />
            </g>
            <circle fill={this.colortwo} fill-opacity="1" cx="50" cy="30" r="6.047">
              <animate attributeName="opacity" dur="1710ms" begin="0.5s" repeatCount="indefinite" keyTimes="0;1" values="1;0" />
            </circle>
          </svg>
        )
      case 'triangles8':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 128 128" space="preserve">
            <g>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#359444" fill-opacity="1" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#e7f2e9" fill-opacity="0.12" transform="rotate(45 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#e7f2e9" fill-opacity="0.12" transform="rotate(90 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#e7f2e9" fill-opacity="0.12" transform="rotate(135 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#cce4cf" fill-opacity="0.25" transform="rotate(180 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#add3b3" fill-opacity="0.41" transform="rotate(225 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#8cc295" fill-opacity="0.57" transform="rotate(270 64 64)" ></path>
              <path d="M71 39.2V.4a63.6 63.6 0 0 1 33.96 14.57L77.68 42.24a25.53 25.53 0 0 0-6.7-3.03z" fill="#65ad70" fill-opacity="0.76" transform="rotate(315 64 64)" ></path>
              <animateTransform attributeName="transform" type="rotate" values="0 64 64;45 64 64;90 64 64;135 64 64;180 64 64;225 64 64;270 64 64;315 64 64" calcMode="discrete" dur="1120ms" repeatCount="indefinite"></animateTransform>
            </g>
            <g>
              <circle fill={this.color} fill-opacity="1" cx="63.66" cy="63.16" r="12" ></circle>
              <animate attributeName="opacity" dur="1120ms" begin="0s" repeatCount="indefinite" keyTimes="0;0.5;1" values="1;0;1" />
            </g>
          </svg>
        )
      case 'funnel39':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 128 128" space="preserve">
            <path fill={this.colortwo} fill-opacity="1" d="M111.708,49A50.116,50.116,0,0,0,79,16.292V1.785A64.076,64.076,0,0,1,126.215,49H111.708ZM49,16.292A50.114,50.114,0,0,0,16.292,49H1.785A64.075,64.075,0,0,1,49,1.785V16.292ZM16.292,79A50.116,50.116,0,0,0,49,111.708v14.507A64.076,64.076,0,0,1,1.785,79H16.292ZM79,111.708A50.118,50.118,0,0,0,111.708,79h14.507A64.078,64.078,0,0,1,79,126.215V111.708Z">
            ...
            <path fill={this.color} fill-opacity="1" d="M96.971,53.633a34.634,34.634,0,0,0-22.6-22.6V21A44.283,44.283,0,0,1,107,53.633H96.971Zm-43.338-22.6a34.634,34.634,0,0,0-22.6,22.6H21A44.283,44.283,0,0,1,53.633,21V31.029Zm-22.6,43.338a34.634,34.634,0,0,0,22.6,22.6V107A44.283,44.283,0,0,1,21,74.367H31.029Zm43.338,22.6a34.634,34.634,0,0,0,22.6-22.6H107A44.283,44.283,0,0,1,74.367,107V96.971Z">
              <animateTransform attributeName="transform" type="rotate" from="0 64 64" to="90 64 64" dur="2400ms" repeatCount="indefinite"></animateTransform></path>
            <path fill={this.colortwo} fill-opacity="1" d="M85.47,57.25A22.552,22.552,0,0,0,70.75,42.53V36A28.836,28.836,0,0,1,92,57.25H85.47ZM57.25,42.53A22.552,22.552,0,0,0,42.53,57.25H36A28.836,28.836,0,0,1,57.25,36V42.53ZM42.53,70.75A22.552,22.552,0,0,0,57.25,85.47V92A28.836,28.836,0,0,1,36,70.75H42.53ZM70.75,85.47A22.552,22.552,0,0,0,85.47,70.75H92A28.836,28.836,0,0,1,70.75,92V85.47Z">
              <animateTransform attributeName="transform" type="rotate" from="0 64 64" to="-90 64 64" dur="2400ms" repeatCount="indefinite"></animateTransform></path>
          </svg>
        )
      case 'flower75':
